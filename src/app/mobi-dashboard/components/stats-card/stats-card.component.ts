  ...
  template: `
    <div class="relative bg-white shadow-lg rounded-2xl w-full h-full opacity-100 hover:opacity-70 transition-opacity duration-300 overflow-hidden">
      <div class="flex w-full h-3/5 p-4 space-x-4 items-center">
        ...
        <h3 class="text-lg font-light text-gray-600 xl:text-2xl">{{ title }}: </h3>
        <div class="text-2xl font-normal text-sky-600 xl:text-3xl">
            {{ value }}
            <div class="inline-flex items-baseline rounded-full bg-green-100 px-2.5 text-lg xl:text-lg font-medium text-green-800">
